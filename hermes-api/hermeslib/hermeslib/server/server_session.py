...
class ServerSession(object):
    ...
    def _invalid_login_command(self, command, msg):
    ...
    def handle_message(self, msg):
        log("SERVER SESSION({0}): Received\n\t{1}".format(self.protocol.peer, msg))
        ...
        if command.startswith(b'LOGIN'):
            ...
            if command == b'LOGIN':
                ...
                if asymmetric_verify(signature, self.challenge, self.user_key):
                    ...
                    # TODO: Figure out how to handle login failure
            ...
            elif command == b'LOGIN_USERNAME' and self.login_state and self.login_state == self.LoginState.verifying_challenge:
                assert self.user_key
                username = msg
                ...
                self._invalid_login_command(command, msg)
